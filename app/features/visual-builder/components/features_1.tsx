...
export function FeatureSection({ imageProps, itemProps }: FeatureProps) {
  return (
...
export function FeatureSectionSettings({
  ...
  const { id, imageProps, itemProps, onPropsUpdate } = props;
      ...
      <Accordion.Item value={"image"}>
        ...
        <Accordion.Panel>
          <TextInput
            ...
            onChange={(value) =>
              onPropsUpdate(id!, "image", { ...imageProps, src: value })
            }
          />
