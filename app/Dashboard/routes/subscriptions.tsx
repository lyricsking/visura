...
import { getUserSubscriptions, updateUserSubscription, pauseUserSubscription, cancelUserSubscription } from '~/utils/subscriptionUtils';

export const loader = async ({ request }) => {
  const subscriptions = await getUserSubscriptions(request);
