  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      <div className="flex justify-center flex-1 max-w-screen-xl m-0 sm:m-6 bg-white shadow sm:rounded-lg ">
        <div className="lg:w-1/2 xl:w-5/12 px-6 sm:px-12">
          ...
          <div className="w-full flex-1 mt-8">
            <div className="flex flex-col items-center">
              ...
              <button className="hidden w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
