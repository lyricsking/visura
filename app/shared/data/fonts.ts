...
export const fonts: FontDescriptor[] = [
  ...
  {
    rel: "stylesheet",
    href: "https://dotcolon.net/font/aileron/",
    value: "'Aileron', sans-serif",
    name: "Aileron",
  },
  {
    rel: "stylesheet",
    href: "https://www.fontshare.com/fonts/supreme",
    value: "'Supreme', sans-serif",
    name: "Supreme",
  },
  {
    rel: "stylesheet",
    href: "https://www.fontshare.com/fonts/styro",
    value: "'Styro', sans-serif",
    name: "Styro",
  },
];

export const findFontByName = (name: string) => {
